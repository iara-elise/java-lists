...
### ABOUT
Repository containing lists of solved Java exercises, organized by fundamental programming topics.
...
### HOW TO RUN
1. Make sure the JDK is installed and that the environment variables are properly configured
2. Open the terminal and compile the file: javac FileName.java
3. Run the file: java FileName

### NOTES
The exercises are part of personal studies, which means the code may be updated as my knowledge advances. 😊
...
### DESCRIÇÃO
Repositório contendo listas de exercícios resolvidos em Java, organizadas por tópicos fundamentais da programação.
...
### COMO EXECUTAR
1. Certifique-se de que o JDK está instalado e que as variáveis de ambiente estejam configuradas
2. Abra o terminal e compile o arquivo: javac NomeDoArquivo.java
3. Execute o arquivo: NomeDoArquivo

### OBSERVAÇÕES
Os exercícios fazem parte de estudos pessoais, isso significa que o código poderá ser atualizado conforme meus conhecimentos avançam. 😊
